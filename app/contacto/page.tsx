    ...
    <main>
      <section className="relative px-6 md:px-16 pt-[180px] pb-[120px] overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          <div className="max-w-[820px]">
            <span className="block text-xs tracking-[0.24em] uppercase text-brand font-bold">Contacto</span>
            <h1 className="mt-5 text-fg tracking-[-0.035em] leading-[0.94]">
              <span className="block font-extralight text-[clamp(36px,4.8vw,64px)]">Dejanos tu mensaje</span>
              <span className="block font-extrabold text-[clamp(48px,7vw,104px)]">y te respondemos.</span>
            </h1>
            <p className="mt-6 max-w-[560px] text-muted text-[19px] font-light leading-[1.55]">Contanos sobre tu producto, envase o evento. Buscamos juntos la solución de ecodiseño que mejor encaje.</p>
          </div>
            ...
            <Reveal delay={0.12}>
              <div className="flex flex-col gap-[30px]">
                <div>
                  ...
                  <p className="mt-3.5 text-fg text-lg font-normal leading-[1.6]">Río de Janeiro 137</p>
                  <p className="mt-0.5 text-muted text-base font-light leading-[1.6]">Villa Allende, Córdoba · Argentina</p>
                </div>
                <div>
                  <span className="block text-xs tracking-[0.16em] uppercase text-brand font-bold">Horario</span>
                  <p className="mt-3.5 text-muted text-base font-light leading-[1.6]">Lunes a viernes · 9:00 – 18:00 h</p>
                </div>
      ...
      <section id="mapa" className="relative w-full h-screen overflow-hidden bg-bg1">
        ...
        <div className="absolute left-[52%] top-[42%] -translate-x-1/2 -translate-y-full">
          <div className="flex flex-col items-center">
            <div className="bg-fg text-bg0 px-4 py-2.5 rounded-[12px] shadow-[0_12px_30px_rgba(0,0,0,0.25)] whitespace-nowrap text-center">
              <span className="block text-[11px] tracking-[0.18em] text-brand font-bold">XIPA</span>
              <span className="block text-sm font-semibold mt-0.5">Río de Janeiro 137</span>
            </div>
        ...
        <div className="absolute left-8 md:left-16 bottom-12 flex flex-col gap-2">
          ...
          <span className="text-muted text-[11px] font-semibold tracking-[0.14em]">31.29° S · 64.29° O</span>
        </div>
        <a href="https://www.google.com/maps/search/?api=1&query=Xipa+Villa+Allende+C%C3%B3rdoba" target="_blank" rel="noopener" className="absolute right-8 md:right-16 bottom-12 inline-flex items-center gap-2.5 px-7 py-[15px] bg-brand text-white font-semibold text-[15px] rounded-full no-underline shadow-[0_14px_34px_rgba(255,77,14,0.3)] transition-transform hover:-translate-y-0.5">Cómo llegar ↗</a>
      </section>
    </main>
  );
}
