    ...
    <section className="relative w-full h-[165vh] bg-bg6 border-t border-line3">
      <div className="sticky top-0 min-h-screen flex items-center justify-center px-6 md:px-12 py-[120px]">
        <div className="max-w-[760px] mx-auto text-center">
          <span className="block text-xs tracking-[0.24em] uppercase text-brand font-bold">Newsletter</span>
          <h2 className="mt-[18px] text-fg tracking-[-0.03em] leading-none">
            <span className="block font-extralight text-[clamp(30px,4vw,46px)]">Sumate a la evolución</span>
            <span className="block font-extrabold text-[clamp(40px,5.6vw,64px)]">del plástico.</span>
          </h2>
          <p className="mt-[22px] mx-auto max-w-[480px] text-muted text-[17px] font-light leading-[1.55]">Novedades de ecodiseño, economía circular y nuevos proyectos. Sin spam, solo lo que importa.</p>
          {!done ? (
            ...
            <p className="mt-[18px] text-brand text-sm font-semibold">¡Gracias! Te sumaste a la newsletter.</p>
          )}
          <p className="mt-4 mx-auto text-muted text-xs font-light">Al suscribirte aceptás nuestra política de privacidad.</p>
        </div>
      </div>
    </section>
  );
